...
export function parseGameLogDateInput(value: any) {
...
export function toGameLogDateInputValue(date: any) {
...
export function isoToGameLogDateInputValue(value: any) {
...
export function toGameLogIsoRangeStart(value: any) {
...
export function toGameLogIsoRangeEnd(value: any) {
    const date = parseGameLogDateInput(value);
    if (!date) {
        return '';
    }
...
function addCalendarDays(date: any, days: any) {
...
export function clampGameLogSessionDateInputRange(from: any, to: any) {
