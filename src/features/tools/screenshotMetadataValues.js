...
export const DEFAULT_SCREENSHOT_SEARCH_SORT = {
    key: 'dateTime',
    asc: false
};
...
export function getScreenshotSearchSortValue(row, key) {
    if (key === 'dateTime') {
...
export function sortScreenshotSearchRows(rows, sort) {
...
export function formatScreenshotBytes(bytes) {
