...
import { useScreenshotGalleryGrid } from '../useScreenshotGalleryGrid.js';
import { EmptyState } from './ScreenshotMetadataParts.jsx';
import {
    ScreenshotThumbnailCard,
    useScreenshotThumbnailTitleMap
} from './ScreenshotThumbnailGrid.jsx';

function buildFolderTree(folderTree) {
...
function folderContainsSelected(node, selectedFolder) {
...
function FolderTreeNode({ node, selectedFolder, onSelectFolder }) {
