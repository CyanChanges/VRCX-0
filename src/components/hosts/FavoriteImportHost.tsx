...
function getRowName(type: any, row: any) {
    if (type === 'friend') {
...
function getRowDetail(type: any, row: any) {
    if (type === 'friend') {
...
function openRowDialog(type: any, row: any) {
    if (type === 'avatar') {
                        ...
                        <TableHeader>
                            <TableRow>
                                <TableHead className="w-16">
                                    {t('dialog.favorite_import.label.image')}
                                </TableHead>
                                <TableHead>
                                    {t('dialog.favorite_import.label.name')}
                                </TableHead>
                                <TableHead>
                                    {t('dialog.favorite_import.label.detail')}
                                </TableHead>
                                <TableHead>ID</TableHead>
                                <TableHead className="w-36 text-right">
                                    {t('dialog.favorite_import.label.actions')}
                                </TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
